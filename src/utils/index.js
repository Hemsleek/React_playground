...
export const months = "Jan,Feb,March,April,May,June,July,August,Sep,Oct,Nov,Dec".split(
  ","
);
...
export const monthDayStart = (displayInfo) => new Date(displayInfo.year, displayInfo.month,0).getDay()
